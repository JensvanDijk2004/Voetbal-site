            ...
            <div class="md:flex w-full">
                    ...
                    <a href="{{ route('home') }}">
                        <svg id="a87032b8-5b37-4b7e-a4d9-4dbfbe394641" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="100%" height="auto" viewBox="0 0 744.84799 747.07702">
                            ...
                            <path id="b3ac2088-de9b-4f7f-bc99-0ed9705c1a9d"
                                  ...
                                  transform="translate(-227.576 -76.46149)"
                                  fill="#e6e6e6" />
                            <path id="b2715b96-3117-487c-acc0-20904544b5b7"
                                  data-name="Path 23"
                            ...
                            <path id="b06d66ec-6c84-45dd-8c27-1263a6253192"
                                  ...
                                  transform="translate(-227.576 -76.46149)"
                                  fill="#ccc" />
                            <path id="e73810fe-4cf4-40cc-8c7c-ca544ce30bd4"
                                  data-name="Path 7"
                            ...
                            <path id="bbe451c3-febc-41ba-8083-4c8307a2e73e"
                                  data-name="Path 8"
                            ...
                            <path id="f1094013-1297-477a-ac57-08eac07c4bd5"
                                  data-name="Path 88"
                            ...
                            <path d="M891.68576,806.12757h23.64387a0,0,0,0,1,0,0v14.88687a0,0,0,0,1,0,0H876.7989a0,0,0,0,1,0,0v0A14.88686,14.88686,0,0,1,891.68576,806.12757Z"
                            ...
                            <path d="M849.55636,801.91945a4.47086,4.47086,0,0,1-4.415-3.69726c-6.34571-35.22559-27.08789-150.40528-27.584-153.59571a1.42684,1.42684,0,0,1-.01562-.22168v-8.58789a1.489,1.489,0,0,1,.27929-.87207l2.74024-3.83789a1.47845,1.47845,0,0,1,1.14355-.625c15.62207-.73242,66.78418-2.8789,69.25586.209h0c2.48242,3.10351,1.60547,12.50683,1.4043,14.36035l.00977.19336,22.98535,146.99512a4.51238,4.51238,0,0,1-3.71485,5.13476l-14.35644,2.36524a4.52127,4.52127,0,0,1-5.02539-3.09278c-4.44043-14.18847-19.3291-61.918-24.48926-80.38672a.49922.49922,0,0,0-.98047.13868c.25781,17.60546.88086,62.52343,1.0957,78.0371l.02344,1.6709a4.51811,4.51811,0,0,1-4.09277,4.53614l-13.84375,1.25781C849.83565,801.91359,849.695,801.91945,849.55636,801.91945Z"
                                  transform="translate(-227.576 -76.46149)"
                                  fill="#2f2e41" />
                            <path id="ae7af94f-88d7-4204-9f07-e3651de85c05"
                                  data-name="Path 99"
                            ...
                            <path id="a6768b0e-63d0-4b31-8462-9b2e0b00f0fd"
                                  ...
                                  transform="translate(-227.576 -76.46149)"
                                  fill="#ffffff" />
                            <path id="bfd7963f-0cf8-4885-9d3a-2c00bccda2e3"
                                  data-name="Path 102"
                ...
                <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                    <div class="text-center mb-10">
                        <h1 class="font-bold text-3xl text-gray-900">REGISTREREN</h1>
                        <p>Vul je gegevens in om in te registreren</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="flex flex-wrap mt-4">
                            <div class="w-full sm:w-1/2 pr-3">
                                ...
                                <select id="gender" name="gender" class="mt-1 block appearance-none w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                    <option disabled selected>Geslacht</option>
                                    <option value="Man" >Man</option>
                                    <option value="Vrouw">Vrouw</option>
                                    <option value="Niet-binair">Niet-binair</option>
                                    <option value="Geslachtsloos">Geslachtsloos</option>
                                </select>
                            ...
                            <div class="w-full sm:w-1/2 pr-3">
                                ...
                                <x-text-input id="age" class="block mt-1" type="number" name="age" :value="old('age')" required autocomplete="username" />
